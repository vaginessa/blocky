...
func enableBlocking(_ *cobra.Command, _ []string) error {
	...
	resp, err := client.GetBlockingEnableWithResponse(context.Background())
...
func disableBlocking(cmd *cobra.Command, _ []string) error {
	...
	resp, err := client.GetBlockingDisableWithResponse(context.Background(), &api.GetBlockingDisableParams{
...
func statusBlocking(_ *cobra.Command, _ []string) error {
	...
	resp, err := client.GetBlockingStatusWithResponse(context.Background())
